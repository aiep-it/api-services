...
const createStudentSchema = Joi.object({
  ...
  parentEmail: Joi.string().email().required().messages({
    "string.base": `"parentEmail" phải là chuỗi.`,
    "string.empty": `"parentEmail" không được để trống.`,
    "string.email": `"parentEmail" không hợp lệ. Vui lòng nhập địa chỉ email hợp lệ.`,
    "any.required": `"parentEmail" là bắt buộc.`,
  }),
